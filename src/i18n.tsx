...
const ZH_CN: Translations = {
  ...
  "nav.apps": "应用规则",
  "nav.settings": "设置",
  "header.help": "{hotkey} 打开弹窗。Enter 粘贴，右键复制，Space 触发缩写。",
  "action.group": "分组",
  "action.phrase": "短语",
  ...
  "shortcut.currentPopup": "当前弹窗快捷键",
  "shortcut.captureHint": "在输入框内按新的组合键，保存时会检测是否和系统或其他软件冲突。Backspace 或 Delete 恢复默认值。",
  "shortcut.checking": "正在检测快捷键...",
  "shortcut.saved": "快捷键已保存。",
  "shortcut.conflict": "这个快捷键可能已被系统或其他软件占用，请更换。{error}",
  "shortcut.defaultRestored": "已恢复为默认快捷键，保存后生效。",
...
const EN_US: Translations = {
  ...
  "header.help": "{hotkey} opens the popup. Enter pastes, right click copies, and Space expands abbreviations.",
  "action.group": "Group",
  ...
  "shortcut.currentPopup": "Current popup shortcut",
  "shortcut.captureHint": "Press a new key combination in the field. Saving checks whether the system or another app already uses it. Backspace or Delete restores the default.",
  "shortcut.checking": "Checking shortcut...",
  "shortcut.saved": "Shortcut saved.",
  "shortcut.conflict": "This shortcut may already be used by the system or another app. Choose another one. {error}",
  "shortcut.defaultRestored": "Default shortcut restored. Save to apply it.",
